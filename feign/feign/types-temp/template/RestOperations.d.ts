 ...
 * query params type
 */
export declare type QueryParamType = Record<string, boolean | number | string | Date | UriPathVariable>;
/**
 * uri variable type
 * example url: "http://a.b.com/",{module:"member",id:1}  ==> "http://a.b.com/?module=member&id=1"
 */
export declare type UriVariable = UriPathVariable | QueryParamType;
export {};

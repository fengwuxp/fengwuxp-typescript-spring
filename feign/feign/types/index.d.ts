...
declare class AntPathMatcher implements PathMatcher {
    ...
    private tokenizedPatternCache;
    private stringMatcherCache;
    ...
    private isPotentialMatch;
    private skipSegment;
    private skipSeparator;
    private isWildcardChar;
    private tokenizePath;
    private tokenizePattern;
}
declare class AntPathStringMatcher {
    private variableNames;
    private pattern;
    constructor(pattern: string, caseSensitive?: boolean);
    matchStrings: (str: string, uriTemplateVariables: Map<String, String>) => boolean;
    private quote;

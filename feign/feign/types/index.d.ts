...
declare type MappingMethod = HttpMethod | string;
...
declare type FeignClientType = "http" | "ws" | "rpc" | string;
...
declare type FeignClientExecutorFactory<T extends FeignClient = FeignProxyClient> = (client: T) => FeignClientExecutor;
...
declare type FeignHttpClientFunction<T, R> = (req: T | undefined, options?: FeignRequestOptions) => R;
declare type FeignHttpClientPromiseFunction<T, R = any> = FeignHttpClientFunction<T, Promise<R>>;
...
declare type FeignClientBuilderFunction<T extends FeignProxyClient = FeignProxyClient> = (client: T, clientType: FeignClientType) => T;
/**
